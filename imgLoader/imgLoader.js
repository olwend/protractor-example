/**
 * Created by dhis on 05/05/2015.
 */


// Create an application module for our demo.

var app = angular.module("myApp.imgLoader", []);
...
app.config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/imgLoader', {
        templateUrl: 'imgLoader/imgLoader.html',
        controller: 'imgLoaderCtrl'
    })
}]);
